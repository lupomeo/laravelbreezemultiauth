<nav
    ...
    <div style="float:left; display:block; text-align:left;"><a href="{{ url('/') }}"><img src="/assets/img/icons/Home.svg"  width="25" height="25" ></a></div>
    ...
    <div class="flex items-center gap-3">
        ...
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                ...
                <div><img src="/assets/img/team/useravatar.png"  width="25" height="25" ></div>&nbsp;
