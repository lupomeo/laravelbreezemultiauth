...
<aside
    class="fixed inset-y-0 z-20 flex flex-col py-4 space-y-6 bg-dark shadow-lg dark:bg-dark-eval-1"
    :class="{
    ...
    style="transition-property: width, transform; transition-duration: 150ms; style="background:#1F2937;""
